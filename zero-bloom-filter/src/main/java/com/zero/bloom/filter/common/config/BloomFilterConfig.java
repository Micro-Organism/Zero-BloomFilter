package com.zero.bloom.filter.common.config;

import com.google.common.hash.BloomFilter;
import com.google.common.hash.Funnels;
import com.zero.bloom.filter.common.enums.RedisKeyEnum;
    ...
    public RBloomFilter<String> getRBloomFilter() {
        try {
            ...
            if (RBloomFilterSequence == 1) {
                bloomFilter = redissonClient.getBloomFilter(RedisKeyEnum.USER_REGISTER_CACHE_PENETRATION_BLOOM_FILTER_1.getMessage());
            } else {
                bloomFilter = redissonClient.getBloomFilter(RedisKeyEnum.USER_REGISTER_CACHE_PENETRATION_BLOOM_FILTER_2.getMessage());
            }
